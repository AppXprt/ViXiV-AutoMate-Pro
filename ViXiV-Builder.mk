...
##
## Debug
ProjectName            :=ViXiV-Builder
ConfigurationName      :=Debug
WorkspacePath          :=/home/sudobash/Documents/ViXiV
ProjectPath            :=/home/sudobash/Documents/Automate-Pro
...
ObjectsFileList        :="ViXiV-Builder.txt"
PCHCompileFlags        :=
MakeDirCommand         :=mkdir -p
LinkOptions            :=  $(shell wx-config --libs)  $(shell pkg-config --libs MagickWand tesseract lept opencv)  -lX11 -lXtst
IncludePath            := $(IncludeSwitch)/usr/local/include $(IncludeSwitch)/usr/include  $(IncludeSwitch). $(IncludeSwitch). 
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
LibPath                :=$(LibraryPathSwitch)/usr/local/lib $(LibraryPathSwitch)/usr/lib  $(LibraryPathSwitch). 
...
$(IntermediateDirectory)/Automate-Pro.cpp$(ObjectSuffix): Automate-Pro.cpp $(IntermediateDirectory)/Automate-Pro.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/sudobash/Documents/ViXiV/Automate-Pro.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Automate-Pro.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/wxcrafter_bitmaps.cpp$(ObjectSuffix): wxcrafter_bitmaps.cpp $(IntermediateDirectory)/wxcrafter_bitmaps.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/sudobash/Documents/ViXiV/wxcrafter_bitmaps.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/wxcrafter_bitmaps.cpp$(ObjectSuffix) $(IncludePath)
